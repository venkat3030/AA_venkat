			...
			/*	double pmtamt2 = pmtamt1 * PerAmt;*/
				...
				String SSN4 ="1"+SSN1;
						...
						
					{
						...
						test.log(LogStatus.PASS, "WOR_CCK_2tendertypes_DiffNumbers Completed Successfully ");
					}
					...
					{
						test.log(LogStatus.FAIL, "WOR_CCK_2tendertypes_DiffNumbersnot Completed Successfully ");
					}
