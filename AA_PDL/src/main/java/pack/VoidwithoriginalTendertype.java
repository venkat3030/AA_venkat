...
public class VoidwithoriginalTendertype extends AA_PDL {


	public static void VoidwithoriginalTendertypeextends (String SSN,String FileName) throws Exception{
