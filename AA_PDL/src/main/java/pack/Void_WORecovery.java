...
public class Void_WORecovery extends AA_PDL {
	...
	public static void Void_WORecovery_Cash(String SSN,String FileName) throws Exception{
	...
	public static void Void_WORecovery_OriginalTender(String SSN,String FileName) throws Exception{
	...
	public static void Void_WORecovery_Checktender(String SSN,String FileName) throws Exception{
