...
public class Void_RPPPayment_With2TenderMOwithDiffNumbers extends AA_PDL {

	


	public static void Void_RPPPayment_With2TenderMOwithDiffNumbers_Cash(String SSN,String FileName) throws Exception{
...

		{
...

			{
				...
				test.log(LogStatus.PASS, "Void Transaction Selected After RPPPayment");
				...
				driver.switchTo().frame("main");
					...
					test.log(LogStatus.PASS, "Clicked on Finish Void RPP Payment button ");
					...
					{
						test.log(LogStatus.PASS, "Void RPP Payment Completed Successfully");
						driver.findElement(By.xpath("//input[@value='OK' and @type='button']")).click();
					}
					else
					{
						test.log(LogStatus.FAIL, "Void RPP Payment not Completed Successfully ");
					}
	...
	public static void Void_RPPPayment_With2TenderMOwithDiffNumbers_OriginalTender(String SSN,String FileName) throws Exception{
...

		{
...

			{
				...
				test.log(LogStatus.PASS, "Void Transaction Selected After RPP Payment");
	...
	public static void Void_RPPPayment_With2TenderMOwithDiffNumbers_Checktender(String SSN,String FileName) throws Exception{
